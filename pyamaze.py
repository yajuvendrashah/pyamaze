...
class agent:
    ...
    '''
    def _init_(self,parentMaze,x=None,y=None,shape='square',goal=None,filled=False,footprints=False,color:COLOR=COLOR.blue):
        '''
...
class textLabel:
    ...
    '''
    def _init_(self,parentMaze,title,value):
        '''
...
class maze:
    ...
    '''
    def _init_(self,rows=10,cols=10):
        '''
